...
{
    public partial class SaidaVeiculoView : Form
    {
        Saidas saidas = new Saidas();
        SaidasDAO saidasDAO = new SaidasDAO();
        ...
        public SaidaVeiculoView(Usuarios usuarios, InicioView inicioView)
        {
            InitializeComponent();
        ...
        private void btnRegistrar_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            else
            {
                ...
                saidas.Veiculos_id = veiculo.Id;
                txtVeiculo.Text = veiculo.Modelo;
                saidas.Usuarios_id = usuarios.Id;
                saidas.Data_saida = DateTime.Parse(txtData.Text);
                saidas.Horario_saida = DateTime.Parse(txtHora.Text);
        ...
        private void txtPlaca_TextChanged(object sender, EventArgs e)
        {
            if (txtPlaca.Text.Length == 8)
            {
                ...
                saidas.Data_saida = dataHoraAtual.Date;
                saidas.Horario_saida = dataHoraAtual;
